...
TILEPO_BOOTSTRAPPED_PID = "TILEPO_BOOTSTRAPPED_PID"
...
TILEPO_HOOK_VERIFY_LIMIT = "TILEPO_HOOK_VERIFY_LIMIT"
...
def hook_verify_limit() -> int:
    return get_int(TILEPO_HOOK_VERIFY_LIMIT, 1, min_value=0)
...
def mark_bootstrapped(checksum: str) -> None:
    ...
    os.environ[TILEPO_BOOTSTRAPPED_PID] = str(os.getpid())
